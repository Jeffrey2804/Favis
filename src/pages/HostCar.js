...
export default function HostCar() {
  const [cars, setCars] = useState([]);

  useEffect(() =>{
     fetch(`${process.env.REACT_APP_API_URL}/cars/viewall-host-car`,{
         headers : { 
...
<MDBContainer fluid> 
  <AppNavbar />
    <h1 className="display-3 text-uppercase text-center text-dark mb-3">Host Car Listing</h1>
